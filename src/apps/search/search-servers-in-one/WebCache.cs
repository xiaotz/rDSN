...
namespace dsn.app.search
{
  public partial class WebCache {
    public interface Iface {
      ...
      #if SILVERLIGHT
      IAsyncResult Begin_Get(AsyncCallback callback, object state, AugmentedQuery query);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_Get(AsyncCallback callback, object state, AugmentedQuery query)
      {
      ...
      public QueryResult @Get(AugmentedQuery query)
      {
        #if !SILVERLIGHT
        send_Get(query);
        return recv_Get();
      ...
      #if SILVERLIGHT
      public IAsyncResult send_Get(AsyncCallback callback, object state, AugmentedQuery query)
      #else
      public void send_Get(AugmentedQuery query)
      #endif
      {
